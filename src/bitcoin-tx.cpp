...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " inticoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  inticoin-tx [options] <hex-tx> [commands]  Update hex-encoded inticoin transaction\n" +
            "or:     inticoin-tx [options] -create [commands]   Create hex-encoded inticoin transaction\n" +
            "\n";
