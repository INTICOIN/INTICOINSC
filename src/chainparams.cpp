...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 7680000; // INTICOIN halving every 14.6 years
        ...
        vSeeds.emplace_back("seed1.inticoin.com"); // mainnet
        vSeeds.emplace_back("seed2.inticoin.com"); // mainnet
        vSeeds.emplace_back("seed3.inticoin.com"); // mainnet
        vSeeds.emplace_back("seed4.inticoin.com"); // mainnet
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed1.inticoin.com"); // Qtum testnet
