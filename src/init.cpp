 ...
 */
static const char* BITCOIN_PID_FILENAME = "inticoind.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/INTICOIN/INTICOIN>";
    const std::string URL_WEBSITE = "<https://inticoin.com>";
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                fs::path qtumStateDir = GetDataDir() / "stateINTICOIN";
