...
QString BitcoinUnits::longName(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("μINTI (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("INTICOIN");
    case mBTC: return QString("Milli-INTICOIN (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-INTICOIN (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
// NOTE: Using formatWithUnit in an INTI context risks wrapping
...
QString BitcoinUnits::formatHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    ...
    str.replace(QChar(THIN_SP_CP), QString(THIN_SP_INTI));
